...
##
golem::fill_desc(
  pkg_name = "latexer", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
  ...
  authors = person(
    given = "Sulman Olieko", # Your First Name
    family = "Owili", # Your Last Name
    email = "oliekosulman@gmail.com", # Your email
